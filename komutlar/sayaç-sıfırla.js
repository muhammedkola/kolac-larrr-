...
if(!sayı && !kanal) return message.reply(`<a:dikkat:707520390242631804>Sayaç Sistemi Zaten Ayarlı Değil! **Ayarlamak İçin** : \`${prefix}sayaç #kanal 100\``)
db.delete(`SayaçSayı_${message.guild.id}`) 
db.delete(`SayaçKanal_${message.guild.id}`) 
message.reply(`<a:tiks:743841333692727378>Sayaç Başarıyla Sıfırlandı`)
};
