...
exports.run = async (client, message, args) => {
  ...
  const istatistikler = new Discord.MessageEmbed()
    .setColor("RANDOM")
  .setImage ("https://cdn.discordapp.com/avatars/727092647503855718/2a1566da022dbdce4f29a4b23329d3bb.webp") 
  .setTimestamp()
    .setFooter("© 2020 Kola-BOT", client.user.avatarURL())
    .addField("» **Botun Sahibi**", "<@717393740221644892>\n<@783339987276922961>\n<@786967303694057482>")
    ...
    .addField("**» Bot Davet**"," [Davet Et](https://discord.com/oauth2/authorize?client_id=727092647503855718&permissions=8&scope=bot" + client.user.id + "&scope=bot&permissions=8)");
